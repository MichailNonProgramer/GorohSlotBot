...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="Devy" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" main.java.com.urfu.Devy.Main %CMD_LINE_ARGS%
