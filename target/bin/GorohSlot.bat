...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="GorohSlot" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" com.urfu.GorohSlot.Main %CMD_LINE_ARGS%
